const gridCols = 24;
const gridRows = 14;
const layoutKeyPrefix = "PiServerLayout:0_2_11:";
const pagePanels = {
...
const defaultLayouts = {
  manual: {
    ...
    viewer: { c: 1, r: 4, w: 13, h: 8 },
    drive: { c: 14, r: 4, w: 11, h: 4 },
    manual: { c: 14, r: 8, w: 11, h: 4 },
    record: { c: 1, r: 12, w: 6, h: 3 },
    system: { c: 7, r: 12, w: 18, h: 3 }
  },
  training: {
    status: { c: 1, r: 1, w: 24, h: 3 },
    viewer: { c: 1, r: 4, w: 13, h: 8 },
  ...
  auto: {
    status: { c: 1, r: 1, w: 24, h: 3 },
    viewer: { c: 1, r: 4, w: 14, h: 8 },
    drive: { c: 15, r: 4, w: 10, h: 4 },
    manual: { c: 15, r: 8, w: 10, h: 4 },
    record: { c: 1, r: 12, w: 6, h: 3 },
    system: { c: 7, r: 12, w: 18, h: 3 }
  },
  camera: {
    status: { c: 1, r: 1, w: 24, h: 3 },
    viewer: { c: 1, r: 4, w: 11, h: 8 },
    camera: { c: 12, r: 4, w: 13, h: 8 },
    system: { c: 1, r: 12, w: 24, h: 3 }
  },
  motor: {
    status: { c: 1, r: 1, w: 24, h: 3 },
    viewer: { c: 1, r: 4, w: 11, h: 8 },
    motor: { c: 12, r: 4, w: 13, h: 8 },
    system: { c: 1, r: 12, w: 24, h: 3 }
  }
};
