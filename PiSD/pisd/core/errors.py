...
class PiSDErrorCodes:
    ...
    SETTINGS_LOAD_FAILED = "PISD-SET-001"
    SETTINGS_SAVE_FAILED = "PISD-SET-002"
    SETTINGS_INVALID_PAYLOAD = "PISD-SET-003"
    SETTINGS_APPLY_FAILED = "PISD-SET-004"
    SETTINGS_RESET_FAILED = "PISD-SET-005"
    ...
    RECORDING_ITEM_NOT_FOUND = "PISD-REC-008"
