(() => {
  ...
  function roadGuideGeometry(throttle, steering) {
    ...
    // PiSD_0_6_2: predict the turn as a small kinematic bicycle-style
    // ground-plane trajectory, then offset road edges from local tangents
    // before projection.  This makes sharp turns read as a real future path
    // instead of a decorative SVG bow.  Keep the accepted screen convention:
    // negative/left steering shifts the visible future path to the right side
    // of the camera frame.
