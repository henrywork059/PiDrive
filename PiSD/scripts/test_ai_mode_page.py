...
def check_source_contract() -> Result:
    ...
    required = {
        ...
        "css": [".ai-shell", ".ai-grid", ".ai-preview-frame", ".ai-preview-run-actions", ".ai-button-danger", "mdrv-drive-overlay", ".ai-runtime-help", "#aiFilesPanel", "#aiStartPreview.mdrv-button", "rgba(251, 191, 36", ".ai-intro-actions", ".ai-settings-popup", "#aiWorkflowSettingsStatus", ".ai-error-log-panel", ".ai-assist-pane", "@media (max-width: 980px)"],
        "js": [
            "aiModeInitialStatus",
            "/api/ai/models",
            "/api/ai/load-model",
            ...
            "ai-manual-keyboard",
            "ai-assist-keyboard",
            "assistOutputSteering",
            "latestAssistModelSteering",
            "ai_assist",
            "refreshLastErrors",
            "/api/errors",
        ...
        "app": ["keep_ai_preview", "Motors stopped; AI preview kept.", "ai=ai_drive_service.status()", "settings=settings_manager.get()", "errors=all_errors"],
    }
