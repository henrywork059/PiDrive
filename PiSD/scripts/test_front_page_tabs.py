...
def check_source_contract() -> list[Result]:
    ...
    expected = {
        ...
        "front_css": [".fp-shell", ".fp-mode-grid", ".fp-mode-card", "#frontModeManualDrive", "#frontModeAiMode", "rgba(34,197,94", "@media (max-width: 760px)"],
    ...
    back_link_sources = {
        ...
        "ai_mode": AI_TEMPLATE.read_text(encoding="utf-8"),
...
def check_routes(hardware: bool) -> list[Result]:
    ...
    route_checks = [
        ...
        ("/ai-mode", "front_page.route.ai_mode", b"PiSD AI Mode", b"Back to Front Page"),
    ...
    for path, label, marker in (
        ...
        ("/testing/static/css/ai_mode.css", "front_page.static.ai_css", b".ai-shell"),
        ("/testing/static/js/ai_mode.js", "front_page.static.ai_js", b"aiModeInitialStatus"),
